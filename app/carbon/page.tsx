        ...
        <section className="relative py-20 lg:py-32">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-4xl mx-auto mb-12">
              <div className="inline-flex items-center bg-white/80 backdrop-blur-sm px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16 py-2 rounded-full shadow-md border border-green-200 mb-6">
