...
export const MessagingNode = memo(({ data, selected, id }: NodeProps) => {
  ...
  const outputs = [{ id: 'output', label: 'Sent' }]
    ...
    <div className={cn(
      ...
      {outputs.map((output, idx) => (
        <Handle
          ...
          id={output.id}
          className="!w-2.5 !h-2.5 !bg-[#0ea5e9] !border-2 !border-[#0284c7] !rounded-sm"
          style={{ 
